...
// Fraidyscrape
//
// The rule-based HTML/JSON/text scraper that drives every feed fetch. Vendored
// from the `fraidyscrape` npm package (v1.0.16) so it lives as an internal
// library - see ./LICENSE for the original attribution. Only the runtime
// engine is kept here; the package's standalone CLI/webext build (which pulled
// in electron-fetch, @xmldom/xmldom and regenerator-runtime) is not.
//
